...
class ListProductsByCategoryController {
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const listProductsByCategory = new ListProductsByCategoryService_1.ListProductsByCategoryService();
            const products = yield listProductsByCategory.execute({ category_id });
